...
@pytest.fixture
def unauthenticated_web_api() -> WebPixivAPI:
...
EXAMPLE_USER_PROFILE_ALL_RESPONSE = {
  ...
  "body": {
    ...
    "pickup": [
      ...
      {"id": "79448157", "title": "端木鱼", "illustType": 0, "aiType": 1, "xRestrict": 0, "restrict": 0, "sl": 2, "url": "https://i.pximg.net/c/288x288_80_a2/img-master/img/2020/08/12/13/22/12/79448157_p0_square1200.jpg", "description": "", "tags": ["可愛い", "女の子", "花嫁", "白髪", "風景", "かわいらしい", "ふつくしい", "クリック推薦", "端木鱼", "オリジナル1000users入り"], "userId": "9153585", "userName": "haku89", "width": 4299, "height": 2643, "pageCount": 1, "isBookmarkable": True, "bookmarkData": None, "visibilityScope": 0, "alt": "#可愛い 端木鱼 - haku89のイラスト", "titleCaptionTranslation": {"workTitle": None, "workCaption": None}, "createDate": "2020-02-13T00:24:22+09:00", "updateDate": "2020-08-12T13:22:12+09:00", "isUnlisted": False, "isMasked": False, "urls": {"250x250": "https://i.pximg.net/c/250x250_80_a2/img-master/img/2020/08/12/13/22/12/79448157_p0_square1200.jpg", "360x360": "https://i.pximg.net/c/360x360_70/img-master/img/2020/08/12/13/22/12/79448157_p0_square1200.jpg", "540x540": "https://i.pximg.net/c/540x540_70/img-master/img/2020/08/12/13/22/12/79448157_p0_square1200.jpg"}, "type": "illust", "deletable": True, "draggable": True, "contentUrl": "https://www.pixiv.net/artworks/79448157"}
    ],
...
def test_get_user_profile_all_success(web_api: WebPixivAPI):
    ...
    assert isinstance(result, WebUserProfileAll)
...
EXAMPLE_USER_FOLLOWING_RESPONSE = {
  ...
  "body": {
    "users": [
      {"userId": "5083537", "userName": "RAI", "profileImageUrl": "https://i.pximg.net/user-profile/img/2020/04/03/10/29/02/18251768_c26449c8f7bfe4cbb2c345ae3d7ea0f3_170.jpg", "userComment": "...", "following": False, "followed": False, "isBlocking": False, "isMypixiv": False, "illusts": [{"id": "101010718", "title": "ウタゲ", "illustType": 0, "aiType": 1, "xRestrict": 0, "restrict": 0, "sl": 2, "url": "https://i.pximg.net/c/250x250_80_a2/img-master/img/2022/09/05/08/46/48/101010718_p0_square1200.jpg", "description": "", "tags": ["ウタゲ", "Arknights", "アークナイツ", "明日方舟", "rkgk"], "userId": "5083537", "userName": "RAI", "width": 694, "height": 1284, "pageCount": 1, "isBookmarkable": True, "bookmarkData": None, "visibilityScope": 0, "alt": "#ウタゲ ウタゲ - RAIのイラスト", "titleCaptionTranslation": {"workTitle": None, "workCaption": None}, "createDate": "2022-09-05T08:46:48+09:00", "updateDate": "2022-09-05T08:46:48+09:00", "isUnlisted": False, "isMasked": False, "profileImageUrl": "https://i.pximg.net/user-profile/img/2020/04/03/10/29/02/18251768_c26449c8f7bfe4cbb2c345ae3d7ea0f3_50.jpg"}], "novels": [], "commission": None},
      {"userId": "61362279", "userName": "老陳LaoChen🔥", "profileImageUrl": "...", "userComment": "...", "following": False, "followed": False, "isBlocking": False, "isMypixiv": False, "illusts": [{"id": "100903553", "title": "jk大凤r18差分", "illustType": 0, "aiType": 1, "xRestrict": 1, "restrict": 0, "sl": 6, "url": "...", "description": "", "tags": ["R-18", "巨乳", "大鳳(アズールレーン)", "アズールレーン", "タイツ足裏", "タイツ", "下校後の甘い時間", "くぱぁ", "アズールレーン500users入り", "風紀を乱す風紀委員"], "userId": "61362279", "userName": "老陳LaoChen🔥", "width": 1152, "height": 1920, "pageCount": 4, "isBookmarkable": True, "bookmarkData": None, "visibilityScope": 0, "alt": "...", "titleCaptionTranslation": {"workTitle": None, "workCaption": None}, "createDate": "2022-08-31T22:59:35+09:00", "updateDate": "2022-08-31T22:59:35+09:00", "isUnlisted": False, "isMasked": False, "profileImageUrl": "..."}], "novels": [], "commission": None},
      {"userId": "1680108", "userName": "ふむゆん", "profileImageUrl": "...", "userComment": "...", "following": False, "followed": False, "isBlocking": False, "isMypixiv": False, "illusts": [{"id": "100307516", "title": "C100", "illustType": 0, "aiType": 1, "xRestrict": 0, "restrict": 0, "sl": 2, "url": "...", "description": "", "tags": ["オリジナル", "オフショルダーワンピース", "ドレス", "女の子", "黒髪", "オリジナル3000users入り"], "userId": "1680108", "userName": "ふむゆん", "width": 1556, "height": 2593, "pageCount": 1, "isBookmarkable": True, "bookmarkData": None, "visibilityScope": 0, "alt": "...", "titleCaptionTranslation": {"workTitle": None, "workCaption": None}, "createDate": "2022-08-07T20:45:36+09:00", "updateDate": "2022-08-07T20:46:06+09:00", "isUnlisted": False, "isMasked": False, "profileImageUrl": "..."}], "novels": [], "commission": None}
...
@respx.mock
def test_get_user_following_success(web_api: WebPixivAPI):
    ...
    result = web_api.get_user_following(TEST_USER_ID, offset=0, limit=3)

    assert isinstance(result, WebFollowingUser)
...
@pytest.mark.asyncio
@respx.mock
async def test_async_get_user_following_success(web_api: WebPixivAPI):
    ...
    result = await web_api.async_get_user_following(TEST_USER_ID, offset=0, limit=3)
...
@respx.mock
def test_get_user_following_requires_auth(unauthenticated_web_api: WebPixivAPI):
    ...
    with pytest.raises(PixivError, match="Authentication required"):
        unauthenticated_web_api.get_user_following(TEST_USER_ID, offset=0, limit=3)


# TODO: Add tests for authenticated endpoints when implemented, like POST requests
# def test_some_authenticated_endpoint(web_api: WebPixivAPI):
#     ...
